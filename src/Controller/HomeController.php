...
class HomeController extends AbstractController
{
    ...
    public function index(TodayGenerator $todayGenerator): Response
    {
        ...
        // Le dernier article épinglé, destiné à être affiché dans la barrre de news
        $articleForBarreNews = $this->getArticleForBarreNews();
        ...
        $afficherBarrenews = $this->optionsSiteRepository->findOneBy(['nom' => 'barre news homepage']);
        return $this->render('home.html.twig', [
            'menu_courant' => 'home',
            'articleForBarreNews' => $articleForBarreNews,
            'events' => $eventsToCome,
            'epoque' => 'futur',
            'today' => $today,
            ...
            'articles' => $articles,
            'afficherBarrenews' => $afficherBarrenews,
        ]);
    }
    ...
    /**
     * On récupère le dernier article actif et épinglé
     */
    private function getArticleForBarreNews()
    {
        $articleForBarreNews = $this->articlesRepository->findOneBy(
            [
                'actif' => true,
                'epingle' => true,
            ],
